...
export default function Pricing() {
  return (
    <SectionReveal id="pricing" className="py-20 bg-gray-50" stagger={0.12}>
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto">
          <motion.h2 className="text-3xl sm:text-4xl font-semibold tracking-tight text-gray-900" variants={revealItem}>
        ...
        <div className="mt-12 grid lg:grid-cols-3 gap-6">
          <motion.div variants={revealItem}>
            <TiltCard className="rounded-2xl bg-white border border-gray-200 p-6">
          ...
          <motion.div variants={revealItem}>
            <TiltCard className="rounded-2xl bg-white border-2 border-gray-900 p-6 scale-[1.02] shadow-lg">
